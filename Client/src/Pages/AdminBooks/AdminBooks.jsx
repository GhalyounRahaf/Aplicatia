...
import { getBooksApi, addToCartApi, deleteBookApi, editBookApi } from "../../apis/apis.js";
...
//   const handleEdit = async(book, quantity) => {
//     try {
//         const res = await editBookApi({book: book, quantity: quantity})
            ...
            <div className="gallery-item" key={index}>
              ...
              <div className="popularbook-info">
                ...
                <button
                  ...
                  onClick={() => navigate(`/dashboard/book/${item.id}`)}
                >
                  Edit
                </button>
                <button
