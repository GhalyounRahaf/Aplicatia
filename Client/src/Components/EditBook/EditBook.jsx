...
import { addBookApi, editBookApi, getBookApi } from "../../apis/apis.js";
...
const EditBook = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await editBookApi(id,data);
  ...
  useEffect(() => {
    async function fun() {
        await getBookApi(id).then(res=> {
            console.log(res);
          const data = res;
          // console.log(data.data.data.orders);
          const jsonData = data.data.data.book;
          console.log(jsonData);
          setBook(jsonData);
          setFormData({
            title: jsonData.title,
            author: jsonData.author,
            category: jsonData.category.id,
